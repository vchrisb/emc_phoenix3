        ...
        for service in VCAP_SERVICES[group]:
            ...
            # sendgrid does override "mail" and will use sendgrid web API
                ...
                if service['credentials']['DEBUG'] == 'True':
                    ...
                    DEBUG = False
                if service['credentials']['SECURE_SSL_REDIRECT'] == 'True':
                ...
                SENDGRID_API_KEY = service['credentials']['SENDGRID_API_KEY']
                import ast
...
ALLOWED_DOMAINS = ['dell.com','emc.com', 'vmware.com', 'vce.com', 'rsa.com', 'virtustream.com', 'pivotal.io']
