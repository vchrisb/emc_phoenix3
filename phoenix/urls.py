...
urlpatterns = [
    ...
    #boothcrawl
    url(r'^boothcrawl/qrcode/(?P<uuid>[0-9a-z-]+)$', boothcrawl.views.qrcode, name='qrcode'),
    url(r'^boothcrawl/qrcodes/$', boothcrawl.views.qrcodes, name='qrcodes'),
    url(r'^boothcrawl/crawl/(?P<uuid>[0-9a-z-]+)/(?P<otp>[0-9]{6})/$', boothcrawl.views.crawl, name='crawl'),
    url(r'^boothcrawl/badges/$', boothcrawl.views.badges, name='badges'),
    url(r'^boothcrawl/scores/$', boothcrawl.views.crawl_score_list, name='crawl_score_list')
